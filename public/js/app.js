...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_buefy__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_buefy___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_buefy__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__routes_js__ = __webpack_require__(20);
...
window.VueRouter = __webpack_require__(7).default;
window.axios = __webpack_require__(43).default;
Vue.use(__WEBPACK_IMPORTED_MODULE_0_buefy___default.a, { defaultIconPack: 'fa' }, VueRouter, axios);
/**
 * Next, we will create a fresh Vue application instance and attach it to
 * the page. Then, you may begin adding components to this application
 * or customize the JavaScript scaffolding to fit your unique needs.
 */
var AppLayout = Vue.component('app-layout', __webpack_require__(62));

new Vue(Vue.util.extend({ router: __WEBPACK_IMPORTED_MODULE_1__routes_js__["a" /* default */] }, AppLayout)).$mount('#mainLayout');
...
var DashboardLayout = __WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('dashboard-layout', __webpack_require__(22));
var HomeLayout = __WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('home-layout', __webpack_require__(26));
var LoginLayout = __WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('login-layout', __webpack_require__(32));
var Logout = __WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('logout', __webpack_require__(35));

var Landing = __WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('Landing', __webpack_require__(38));
var routes = [{
    name: 'LoginLayout',
    path: '/login',
...
router.beforeEach(function (to, from, next) {
    ...
    }) && !__WEBPACK_IMPORTED_MODULE_2__store__["a" /* default */].state.isLoggedIn) {
        // redirect to login page
        next({ name: 'Landing' });
        return;
    }

    if (to.path === '/dashboard' && !__WEBPACK_IMPORTED_MODULE_2__store__["a" /* default */].state.isLoggedIn) {
        next({ name: 'Landing' });
        return;
    }
...
Component.options.__file = "resources/js/components/Layout/dashboardLayout.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c4318cb8", Component.options)
  } else {
    hotAPI.reload("data-v-c4318cb8", Component.options)
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_top_progress__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_top_progress___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue_top_progress__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        vueTopprogress: __WEBPACK_IMPORTED_MODULE_0_vue_top_progress__["vueTopprogress"]
    },
    data: function data() {
        return {
            user: {},
    ...
    created: function created() {
        ...
        axios.get('/api/user', {
            ...
            if (response.data.status == "Token is Expired") {
                ...
                if (_this.roles == 'user') {
                    if (_this.user.detail.status == 0) {
                        _this.activeFirst = true;
                    }
                }
            }
            ...
            axios.get('/api/refresh', {
                ...
                axios.get('/api/user', {
                    ...
                    if (response.data.status == "Token is Expired") {
                        ...
                        _this3.user = response.data.userdata;
                        if (_this3.roles == 'user') {
                            if (_this3.user.detail.status == 0) {
                                _this3.activeFirst = true;
                            }
                        }
                    }
                }).catch(function (error) {
  ...
  return _c(
    ...
    [
      ...
      _vm.loading == true
        ? _c("div")
        : _c("div", [
            _c("div", { staticClass: "topnav", attrs: { id: "topnav" } }, [
              _c(
                "nav",
                {
                  staticClass: "navbar has-shadow dashnav",
                        ...
                        _c("div", { staticClass: "navbar-item" }, [
                          _c(
                            "div",
                            {
                              ...
                              attrs: {
                                id: "textRightNav",
                                onclick: "rightDropDown()"
                              }
                            },
                            [
                              _c("p", { staticClass: "mute-text" }, [
                                _vm._v(
                                  "\n                             " +
                                    _vm._s(_vm.roles) +
                                    "\n                         "
            ...
            _c(
              "div",
              { staticClass: "side-menu", attrs: { id: "side-menu" } },
              [
                _c("aside", { staticClass: "menu" }, [
                  _c(
                    "div",
                    {
                      ...
                      attrs: { id: "side-header" }
                    },
                    [
                      _c(
                        "div",
                        { staticClass: "menu-label imgLabel" },
                        [
                          _c(
                            "router-link",
                  ...
                  _vm._v(" "),
                  _c("hr", { staticClass: "separator-side" }),
                  _vm._v(" "),
                  _c("div", { staticClass: "side-body" }, [
                    _c("div", { staticClass: "side-label" }, [
                      _vm._v("\n                     HOME\n                 ")
                    ]),
                    _vm._v(" "),
                    _c("ul", { staticClass: "menu-list" }, [
                      _c(
                        ...
                        [
                          _c(
                            "router-link",
                            { attrs: { to: { name: "DashboardContent" } } },
                            [
                              _c("i", {
                                staticClass: "fa fa-home m-r-10",
                                attrs: { "aria-hidden": "true" }
                              }),
                              _vm._v(" "),
                          ...
                          _c(
                            "router-link",
                            {
                              attrs: {
                                to: {
                                  name: "PostComponent",
                                  params: { kategori: "PPDB" }
                                }
                              }
                            },
                            [
                              _c("i", {
                                staticClass: "fa fa-file m-r-10",
                                attrs: { "aria-hidden": "true" }
                              }),
                              _vm._v(" "),
                              _c("span", [_vm._v("Buku Saya")])
                            ]
                          )
                        ],
                        1
            ...
            _vm.roles == "user"
              ? _c(
                  ...
                  {
                    staticClass: "modal",
                    class: { "is-active": _vm.activeFirst }
                  },
                  [
                                      ...
                                      directives: [
                                        {
                                          name: "model",
                                          rawName: "v-model",
                                          value: _vm.dataPassword.password_baru,
                                          expression:
                                            "dataPassword.password_baru"
                                        }
                                      ],
                                      staticClass: "input",
                                      class: { "is-danger": _vm.wrongPassword },
                                ...
                                _c("div", { staticClass: "field" }, [
                                  ...
                                  _c("p", { staticClass: "control" }, [
                                    _c("input", {
                                      directives: [
                                        {
                                          ...
                                          value:
                                            _vm.dataPassword
                                              .password_konfirmasi,
                                          expression:
                                            "dataPassword.password_konfirmasi"
                                        }
                                      ],
                                      staticClass: "input",
                                      class: { "is-danger": _vm.wrongPassword },
                                      ...
                                      domProps: {
                                        value:
                                          _vm.dataPassword.password_konfirmasi
                                      },
                                      on: {
                                        keyup: _vm.cek,
                                        input: function($event) {
                          ...
                          _c("footer", { staticClass: "modal-card-foot" }, [
                            _c(
                              "button",
                              {
                                ...
                                attrs: { disabled: _vm.wrongPassword }
                              },
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "navbar-start" }, [
      _c("div", { staticClass: "navbar-item box-hamburger" }, [
        _c(
          "div",
          { staticClass: "hamburger", attrs: { onclick: "myHamburger(this)" } },
          [
  ...
  function() {
    ...
    return _c("header", { staticClass: "modal-card-head" }, [
      _c(
        "p",
        {
          staticClass: "modal-card-title text-resetpassword",
          staticStyle: { "text-align": "center" }
        },
        [
          _vm._v("Selamat datang "),
          _c("br"),
          _vm._v("silahkan update password anda terlebih dahulu "),
          _c("br"),
          _vm._v(" Terima Kasih")
        ]
      )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-c4318cb8", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/Layout/homeLayout.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-8dbb91da", Component.options)
  } else {
    hotAPI.reload("data-v-8dbb91da", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(9)("68dc1493", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8dbb91da\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./homeLayout.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-8dbb91da\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./homeLayout.vue");
    ...
    created: function created() {
        ...
        axios.get('/api/user', {
            ...
            if (response.data.status == "Token is Expired") {
                ...
                _this2.mssg = response.data.userdata.name;
            }
        }).catch(function (error) {
            _this2.mssg = 'Login';
        });
            ...
            axios.get('/api/refresh', {
                ...
                axios.get('/api/user', {
                    ...
                    if (response.data.status == "Token is Expired") {
                        ...
                        _this3.mssg = response.data.userdata.name;
                    }
                }).catch(function (error) {
                    _this3.mssg = 'Login';
                });
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "content", attrs: { id: "homeLayout" } },
    [
      _c("div", { staticClass: "background-color-all" }),
      _vm._v(" "),
      _c(
        "nav",
        {
      ...
      _c("div", { staticClass: "footer" }, [
        ...
        _c("p", { staticStyle: { "text-align": "center" } }, [
          _vm._v("Copyright © " + _vm._s(_vm.year) + " Bukren")
        ])
      ]),
      _vm._v(" "),
      _c(
        ...
        [
          _c(
            "modal-form",
            _vm._b({ attrs: { type: _vm.type } }, "modal-form", _vm.data, false)
          )
        ],
        1
      )
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "columns" }, [
        _c("div", { staticClass: "column" }, [
          _c("strong", [_vm._v("Bukren")]),
          _vm._v(" "),
          _c("ul", [
            _c("li", [_vm._v("Tentang Kami")]),
            _vm._v(" "),
            _c("li", [_vm._v("Kegiatan Kami")]),
            _vm._v(" "),
            _c("li", [_vm._v("Hubungi Kami")])
          ])
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "column" }, [
          _c("strong", [_vm._v("Metode Transaksi")]),
          _vm._v(" "),
          _c("ul", [
            _c("li", [_vm._v("Beli")]),
            _vm._v(" "),
        ...
        _c("div", { staticClass: "column" }, [
          ...
          _vm._v(" "),
          _c("ul", [
            _c("li", [_vm._v("Syarat dan Ketentuan")]),
            _vm._v(" "),
            _c("li", [_vm._v("Kebijakan Privasi")]),
            _vm._v(" "),
            _c("li", [_vm._v("Panduan Keamanan")])
          ])
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "column iconFollow" }, [
          _c("strong", [_vm._v("Ikuti Kami")]),
          _vm._v(" "),
          _c("ul", [
            _c("li", [_vm._v("icon")]),
            _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-8dbb91da", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/Layout/loginLayout.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-070abf39", Component.options)
  } else {
    hotAPI.reload("data-v-070abf39", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c("div", { attrs: { id: "content" } }, [
    _c("nav", { staticClass: "navbar has-shadow is-dark" }, [
          ...
          [
            _c(
              ...
              [
                ...
                _vm._v(" "),
                _c("p", { staticClass: "m-l-15" }, [
                  _vm._v("SMP Negeri 4 Depok")
                ])
              ]
            )
          ],
      ...
      _c("div", { staticClass: "box-login" }, [
        _vm.loginError
          ? _c("div", { staticClass: "alert alert-danger" }, [
              _c("p", [_vm._v("Password atau Email anda salah")])
            ])
          : _vm._e(),
        _vm._v(" "),
        _vm._m(0),
              ...
              _c("div", { staticClass: "field is-grouped" }, [
                _c("div", { staticClass: "control" }, [
                  _c(
                    "button",
                    {
                      staticClass: "button btn-custom m-t-35",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-070abf39", module.exports)
  }
}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1f6b6510", Component.options)
  } else {
    hotAPI.reload("data-v-1f6b6510", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    mounted: function mounted() {
        ...
        __WEBPACK_IMPORTED_MODULE_0__store__["a" /* default */].commit('logoutUser');
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1f6b6510", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/home/Landing.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-66372912", Component.options)
  } else {
    hotAPI.reload("data-v-66372912", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(9)("1c3172c5", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-66372912\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Landing.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-66372912\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Landing.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    data: function data() {
        return {
            prodis: [{ name: 'Hukum',
                filename: 'Hkm.png' }, { name: 'Akuntasi',
                filename: 'Ak.png' }, { name: 'Ekonomi Pembangunan',
                filename: 'EP.png' }, { name: 'Manajemen',
                filename: 'Man.png' }, { name: 'Teknik Informatika',
                filename: 'TF.png' }, { name: 'Teknik Industri',
                filename: 'TI.png' }, { name: 'Sistem Informasi',
                filename: 'SI.png' }, { name: 'Teknik Sipil',
                filename: 'Sipil.png' }, { name: 'Arsitek',
                filename: 'Arsitek.png' }, { name: 'Teknobiologi',
                filename: 'Tekno.png' }, { name: 'Sosiologi',
                filename: 'Sos.png' }, { name: 'Ilmu Komunikasi',
                filename: 'ilkom.png' }]
    ...
    [
      ...
      _c("div", { staticClass: "container" }, [
        _c("div", { staticClass: "box" }, [
          _c("h2", { staticClass: "navbar-item  " }, [_vm._v("Program Studi")]),
          _vm._v(" "),
          _c(
            "div",
            { staticClass: "columns is-multiline" },
            _vm._l(_vm.prodis, function(prodi) {
              return _c(
                "div",
                { key: prodi.name, staticClass: "column is-one-quarter" },
                [
                    ...
                    _c(
                      ...
                      [
                        _c(
                          ...
                          {
                            attrs: {
                              to: { name: "kategoriList", params: prodi.name }
                            }
                          },
                          [
                            _c("img", {
                              attrs: {
                                src: "./images/icons/" + prodi.filename,
                                alt: ""
                              }
                            })
                          ]
        ...
        _vm._v(" "),
        _c("div", { staticClass: "box" }, [
          _c("h2", { staticClass: "navbar-item  " }, [_vm._v("Gratis")]),
          _vm._v(" "),
          _c(
            "div",
            { staticClass: "columns is-multiline" },
        ...
        _vm._v(" "),
        _c("div", { staticClass: "box" }, [
          _c("h2", { staticClass: "navbar-item  " }, [_vm._v("Sewa")]),
          _vm._v(" "),
          _c(
            "div",
            { staticClass: "columns is-multiline" },
        ...
        _vm._v(" "),
        _c("div", { staticClass: "box" }, [
          _c("h2", { staticClass: "navbar-item  " }, [_vm._v("Jual")]),
          _vm._v(" "),
          _c(
            "div",
            { staticClass: "columns is-multiline" },
      ...
      _c("div", { staticClass: "container" }, [
        _c("div", { staticClass: "columns" }, [
          _c(
            "div",
            {
              staticClass: "column landingInfo",
              staticStyle: { "align-self": "center" }
            },
            [
              _c("h1", [
                _vm._v(
                  "Website Pencarian Referensi Buku Untuk Mahasiswa Semua Program Studi di Indonesia"
                )
              ]),
              _vm._v(" "),
              _c("hr"),
              ...
              _c("p", [
                _vm._v(
                  "Bukren adalah sebuah Website Referensi Buku yang bertujuan untuk mempertemukan pemiliki buku dan pencari buku. Pemiliki buku dapat sekedar meminjamkan bukunya kepada siapapun melalui website ini, ataupun menyewakannya dan juga menjualnya. Transaksi yang dilakukan di website ini dapat dilakukan dengan temu langsung atau COD."
                )
              ])
            ]
          ),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-66372912", module.exports)
  }
}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6ab6b170", Component.options)
  } else {
    hotAPI.reload("data-v-6ab6b170", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6ab6b170", module.exports)
  }
}
